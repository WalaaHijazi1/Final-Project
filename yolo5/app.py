        ...
        try:
            ...
            if 'Messages' in response:
                ...
                if pred_summary_path.exists():
                    ...
                    logger.info(f"Sending GET request to Polybot: {telegram_app_url}/results?predictionId={prediction_id}&results={formatted_results}&receiptHandle={receipt_handle}")
                    requests.get(f"{telegram_app_url}/results?predictionId={prediction_id}&results={formatted_results}&receiptHandle={receipt_handle}")
